...
public class DiskLruCacheUtil {
    ...
    public static final String FORDLER_BITMAP = "bitmap";
    ...
    public String getStringDiskCache(String key) throws IOException {
        InputStream in = getDiskCache(key);
    ...
    public File getDiskCacheDir(Context context, String uniqueName) {
        ...
        Log.d("ThumbnailDownloader",cachePath);
